    ...
    <div class="card-panel">
      <div class="row flex-items-xs-top">
        <div class="col-xs-12 col-md-3">
          <h1>
          Berbagi Ide Melalui Bilikreasi
          </h1>
        </div>
        <div class="col-xs-12 col-md-9">
          <ul class="timeline">
            ...
            <li>
              <i class="fa fa-pencil red darken-2"></i>
              <div class="timeline-item">
                <h3 class="timeline-header no-border">Tulis ide Anda dalam waktu 3 menit</h3>
              </div>
            </li>
            <li>
              <i class="fa fa-upload blue darken-2"></i>
              <div class="timeline-item">
                <h3 class="timeline-header no-border">Upload foto atau video yang berhubungan dengan ide anda</h3>
              </div>
            </li>
            <li>
